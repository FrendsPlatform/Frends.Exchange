...
namespace Frends.Exchange.ReadEmail.Helpers;
...
internal static class ErrorHandler
{
    ...
    internal static Result Handle(this Exception exception, Options options, List<ResultObject> data, bool throwCanceled = true)
    {
        ...
        return ReturnResult(exception, data, options.ErrorMessageOnFailure);
    }
    ...
    private static Result ReturnResult(Exception exception, List<ResultObject> data, string customMessage = null)
    {
